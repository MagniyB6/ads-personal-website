...
export function Cases() {
  const cases = [
    ...
    },
    {
      tag: "Ремонт",
      title: "Эталон PRO",
      result: "454 подписчика",
      budget: "Бюджет: 17 281 ₽",
      cpa: "CPF: 38 ₽",
      bg: "#E8F4F0",
      accent: "#1a3a2e",
      resultColor: "#1a3a2e",
      desc: "Пробовали генерить клиентов в низкий спрос перед новым годом. Решили пролить трафик на сообщество и прокачать его.",
    },
  ];
